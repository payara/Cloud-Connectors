...
NOTE The Azure Service Bus Connector from 0.5.0 onwards uses the new Azure Service Bus 
...
java -jar payara-micro.jar --deploy azure-sb-rar-0.5.0.rar azure-sb-example-0.5.0.jar
```
...
@ConnectionFactoryDefinition(name = "java:comp/env/AzureSBConnectionFactory",
        ...
        resourceAdapter = "azure-sb-rar-0.5.0",
