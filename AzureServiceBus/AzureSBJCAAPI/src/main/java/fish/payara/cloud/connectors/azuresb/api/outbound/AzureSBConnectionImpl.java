 ...
 */
public class AzureSBConnectionImpl implements AzureSBConnection {
    
    private AzureSBManagedConnection myConn;

    AzureSBConnectionImpl(AzureSBManagedConnection aThis) {
        myConn = aThis;
    }
